...
test ('Provides one cent as change when the customer paid with one cent more than required', () => { 
 ...
 test ('Provides a dime as change when customer paid with 10 cents more than required', () => { 
  ...
  test ('Provides a two dimes as change when customer paid with 20 cents more than required', () => { 
    var change = correctChange(1.00,1.20);
     expected.dimes = 2;
     expect(change).toEqual(expected);
 });
 
  test ('Provides a two dimes and four pennies as change when customer paid with 24 cents more than required', () => { 
 ...
 test ('Provides a one dollar as change when customer paid with 100 cents more than required', () => { 
    var change = correctChange(19.00, 20.00);
    expected.dollars = 1;
    expect(change).toEqual(expected);
 });
 
  test ('Provides a five dollar as change when customer paid with 100 cents more than required', () => { 
    var change = correctChange(20.00, 25.00);
    expected.fives = 1;
    expect(change).toEqual(expected);
 });
  ...
  test ('Provides a five, four ones, three quarters, two dimes, and four pennies as change when customer paid with 999 cents more than required', () => { 
    var change = correctChange(20.00, 29.99);
    expected.fives = 1;
    expected. dollars = 4;
    expected.quarters = 3;
    expected.dimes = 2;
